...
class _WomenCareState extends State<WomenCare> {
  ...
  fetchProducts() async {
    QuerySnapshot qn = await _firestoreInstance.collection("WomenCare").get();
    setState(() {
    ...
    return GetBuilder<HomeScreenController>(
      builder: (value) {
        if (value.isLoading.value) {
          ...
          List<WomenCareModel> WomenCares = value.WomenCare;
                ...
                child: Column(
                  children: [
                    ...
                    GridView.builder(
                      ...
                      itemCount: WomenCares.length,
                      itemBuilder: (_, index) {
                        WomenCareModel product = WomenCares[index];
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (_) => ProductDetails(
                                  productName: _WomenCare[index]["product_name"],
                                  productImage: _WomenCare[index]["product_image"],
                                  productPrice: (_WomenCare[index]["product_price"] as num).toDouble(),
                                  productDescription: _WomenCare[index]["product_description"],
                                ),
                              ),
                            );
                          },
