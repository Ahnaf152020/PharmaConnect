...
class SurgiSearchScreen extends StatefulWidget {
  @override
  _SurgiSearchScreenState createState() => _SurgiSearchScreenState();
}

class _SurgiSearchScreenState extends State<SurgiSearchScreen> {
  var inputText = "";
