...
class womenSearchScreen extends StatefulWidget {
  @override
  _womenSearchScreenState createState() => _womenSearchScreenState();
}

class _womenSearchScreenState extends State<womenSearchScreen> {
  var inputText = "";
