...
class persoSearchScreen extends StatefulWidget {
  @override
  _persoSearchScreenState createState() => _persoSearchScreenState();
}

class _persoSearchScreenState extends State<persoSearchScreen> {
  var inputText = "";
