...
class BabySearchScreen extends StatefulWidget {
  @override
  _BabySearchScreenState createState() => _BabySearchScreenState();
}

class _BabySearchScreenState extends State<BabySearchScreen> {
  var inputText = "";
