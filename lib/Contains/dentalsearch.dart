...
class dentalSearchScreen extends StatefulWidget {
  @override
  _dentalSearchScreenState createState() => _dentalSearchScreenState();
}

class _dentalSearchScreenState extends State<dentalSearchScreen> {
  var inputText = "";
