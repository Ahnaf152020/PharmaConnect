...
import 'package:pharmaconnectbyturjo/pages/AppColors.dart';
...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  Future addToCart() async {
    ...
    return _collectionRef
      ...
      "images": widget._product["product_image"],
        ...
        actions: [
          StreamBuilder(
            stream: FirebaseFirestore.instance.collection("users-favourite-items").doc(FirebaseAuth.instance.currentUser!.email)
                .collection("items").where("name",isEqualTo: widget._product['product_name']).snapshots(),
              ...
              children: [
                AspectRatio(
                  ...
                  child: CarouselSlider(
                      items: widget._product['product_image']
